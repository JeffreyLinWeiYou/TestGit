...
# def needToContinue(record):
#     if record[6] in posRankList or record[6] in negRankList:
#         isrank=True
#     else:
#         isrank=False
#     if record[4] >0:
...
#     else:
#         isTargetPrice=False
#     if (isrank==False) and (isTargetPrice==False):
#         return True
#     return False
...
#                 continue 
        ...
        frameData['occurTime']=None
        frameData['nowPrice']=None
...
def needToContinue(row):
    if row[0] in posRankList or row[0] in negRankList:
        isrank=True
    else:
        isrank=False
    if row[8] >0:
