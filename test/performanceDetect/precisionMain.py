...
#             print e
    ...
    def main(self):
        mySqlData=self.performanceHd.getCanPrecision('2016-06-23 10:07:53','2014-07-11 10:38:01')
        ...
        for data in mySqlData:
            ...
            self.performanceHd.updatePrecision(data,str(oracletT_F),str(oraclet_remark))
            print data['date']
            break
        print len(mySqlData)         
